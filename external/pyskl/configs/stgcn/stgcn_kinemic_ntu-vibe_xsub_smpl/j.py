...
ann_file = 'tmp_dataset.pkl'  # This file is generated during train/train_classifier.py
train_pipeline = [
    dict(type='PreNormalize3D'),
    dict(type='GenSkeFeat', dataset='humanml', feats=['j']),
...
evaluation = dict(interval=1, metrics=['top_k_accuracy'], topk=(1,))
log_config = dict(interval=1, hooks=[dict(type='TextLoggerHook')])

# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn/stgcn_kinemic_ntu-vibe_xsub_smpl/j'
