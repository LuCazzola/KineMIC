    ...
    def __init__(self, dataset='nturgb+d', target='keypoint'):
        ...
        if self.dataset == 'nturgb+d':
            ...
            self.pairs = ((0, 0), (1, 0), (2, 1), (3, 2), (4, 3), (5, 0), (6, 5), (7, 6), (8, 7), (9, 0), (10, 9),
                          ...
                          (20, 19))
        elif self.dataset == 'humanml': # SMPL format with 22 joints (no hands)
            self.pairs = ((1, 0), (2, 0), (3, 0), (4, 1), (5, 2), (6, 3), (7, 4), (8, 5), (9, 6), (10, 7), (11, 8),
                          (12, 9), (13, 9), (14, 9), (15, 12), (16, 13), (17, 14), (18, 16), (19, 17), (20, 18),
                          (21, 19))
