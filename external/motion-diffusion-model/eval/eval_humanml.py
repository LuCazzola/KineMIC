...
from data_loaders.unified.motion_loaders.model_motion_loaders import get_mdm_loader  # get_motion_loader
...
def evaluation(eval_wrapper, gt_loader, eval_motion_loaders, log_file, replication_times, 
    ...
    with open(log_file, 'w') as f:
        ...
        # If it's provided, some parts of the evaluation will be done based on action classes
        all_metrics = OrderedDict({'Matching_Score': OrderedDict({}),
        ...
        for replication in range(replication_times):
            ...
            # Text-To-Motion Matching Scores
